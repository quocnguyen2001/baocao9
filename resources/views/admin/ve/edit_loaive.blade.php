    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- /.container-fluid -->
                <div class="container">
                <h3 class="text-center">Cập nhật loại vé</h3><hr>
                    <div class="row">
                        ...
                        <div class="col-12">
                            <form method="POST" role="form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="pro_name">Tên loại vé</label>
                                        <input type="text" class="form-control" id="tenloai" name="tenloai" placeholder="Nhập tên loại vé" value="{{$loaive->tenloai}}">
                                        
                                    </div>
                                    <div class="form-group">
                                        <label for="pro_price">Giá vé</label>
                                        <input type="text" class="form-control" id="giave" name="giave" placeholder="Nhập giá vé" value="{{$loaive->giave}}">
