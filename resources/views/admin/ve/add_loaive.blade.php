    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- /.container-fluid -->
                <div class="container">
                <h3 class="text-center">Thêm loại vé</h3><hr>
                    <div class="row">
                        ...
                        <div class="col-12">
                            <form method="POST" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tenloai" name="tenloai" placeholder="Nhập tên loại vé" >
                                        
                                    </div>
                                    <div class="form-group">
                                        <label for="pro_price">Giá vé</label>
                                        <input type="text" class="form-control" id="giave" name="giave" placeholder="Nhập giá vé" >
